...
#
# Tiles with no sensible photo (the glowing and magical blocks)
...
const SOURCES := {
	...
	Blocks.T_DEEPSTONE: "Rock030",
	Blocks.T_BEDROCK: "Rocks006",
	Blocks.T_SAND: "Ground033",
	Blocks.T_ICE: "Snow006",
	Blocks.T_ROOT_SIDE: "Wood062",
	Blocks.T_ROOT_TOP: "WoodFloor041",
}
