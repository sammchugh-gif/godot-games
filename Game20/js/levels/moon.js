...
export function buildMoon(w) {
  ...
  w.missionData = {
    moon1: { start: [0, ground(0, 8) + 0.5, 8, 0], car: "buggy", carOpts: { color: 0xf0f2f6, trim: 0x3a8ad8, grip: 2.2, awd: true }, cells: [[-30, ground(-30, 10) + 1.2, 10], [-44, ground(-44, -8) + 1.2, -8], [-16, ground(-16, 30) + 1.2, 30], [20, ground(20, 30) + 1.2, 30], [56, ground(56, 20) + 1.2, 20], [60, ground(60, -20) + 1.2, -20], [30, ground(30, -36) + 1.2, -36], [-10, ground(-10, -30) + 1.2, -30]] },
