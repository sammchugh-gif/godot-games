...
export class LaserHall extends MG {
  constructor(G, m) { super(G, m); this.sub = "MIND THE BEAMS"; this.count = L(this, 3, 4, 5, 6); this.slipAllow = 2; this.speed = L(this, 1, 1.15, 1.3, 1.5); this.instr = "Drag anywhere to move. Cross the hall to the desk without touching a beam."; this.W = 20; this.H = 11; this.p = { x: 1.2, y: 5.5 }; this.stick = null; this.gen(); this.zap = 0; this.resets = 0; this.bt = 0; this.slowT = 0; }
  gen() {
