...
SCENES.spain = function () {
  ...
  { const mm = this.M({ map: mosaic(3), rx: 6, ry: 1 }); for (let i = 0; i < 14; i++) { const a = i / 13 * Math.PI, x = 14 + Math.cos(a) * 8, z = -4 + Math.sin(a * 3) * 1.4 - Math.sin(a) * 6; this.box(1.3, 0.8, 0.6, mm, x, 0.4, z, { ry: a }); this.collider(x, z, 0.75, 0.4, a); }
